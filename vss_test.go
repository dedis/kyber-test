...
import (
	...
	"github.com/dedis/kyber-test/proto"
...
func encryptedDealsV4ToBytes(deals []*pedersenv4.EncryptedDeal, useProtobuf bool) ([][]byte, error) {
	dealsBytes := make([][]byte, len(deals))
	for i, deal := range deals {
		var dealBytes []byte
		var err error
...
func (v *V4EncryptedDeal) ToV4EncryptedDeal() *pedersenv4.EncryptedDeal {
	return &pedersenv4.EncryptedDeal{
		DHKey:     v.DHKey,
		Signature: v.Signature,
		Cipher:    v.Cipher,
	}
...
func toV4EncryptedDealFixed(deal *pedersenv4.EncryptedDeal) *V4EncryptedDeal {
...
func protoEncryptedDealToV4EncryptedDeal(protoDeal *proto.EncryptedDeal) *pedersenv4.EncryptedDeal {
	return &pedersenv4.EncryptedDeal{
...
func v4EncryptedDealToProto(deal *pedersenv4.EncryptedDeal) *proto.EncryptedDeal {
